...
function app() {
  ...
  var ListingGrid = _react2.default.createClass({
    ...
    _getListingsJSX: function _getListingsJSX(listings) {
      console.log("====get listings JSX function=====");
      console.log(listings);
      var newArray = [];
      for (var i = 0; i < listings.length; i++) {
        var listingObj = listings[i];
        var component = _react2.default.createElement(Listing, { key: i, listingData: listingObj });
  ...
  var Listing = _react2.default.createClass({
    ...
    _inflation: function _inflation() {
    ...
    render: function render() {
      ...
      if (this.state.fullDescription) descriptionToWrite = grabber.descr;else descriptionToWrite = grabber.descr.substr(0, 140) + "...";

      return _react2.default.createElement(
        "div",
        { className: "listing" },
        _react2.default.createElement("img", { src: this.props.listingData.imageUrl }),
        _react2.default.createElement(
          "p",
          { className: "price" },
          "HOW MUCH?? ",
          ...
          _react2.default.createElement(
            "button",
            { onClick: this._inflation },
            this.state.tickSymbol
          )
        ),
        _react2.default.createElement(
          "p",
  ...
  _reactDom2.default.render(_react2.default.createElement(AppView, { id: "topView", shopData: ironData }), document.querySelector('.container'));
}
